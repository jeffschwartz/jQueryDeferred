...
asyncTest( "getData1", 1, function () {
    ...
    dataPromise.done( function ( data ) {
        ok( true, "getData1 has generated an integer: " + data );
        start();
    } );
...
asyncTest( "getData2", 1, function () {
    ...
    dataPromise.done( function ( data ) {
        ok( true, "getData2 has generated an integer: " + data );
        start();
    } );
...
asyncTest( "getData3", 1, function () {
    ...
    dataPromise.done( function ( data ) {
        ok( true, "getData3 has generated an integer: " + data );
        start();
    } );
...
asyncTest( "getData4", 1, function () {
    ...
    dataPromise.done( function ( data ) {
        ok( true, "getData4 has generated an integer: " + data );
        start();
    } );
...
asyncTest( "getData5", 1, function () {
    ...
    dataPromise.done( function ( data ) {
        ok( true, "getData5 has generated an integer: " + data );
        start();
    } );
...
asyncTest( "getData6", 1, function () {
    ...
    dataPromise.done( function ( data ) {
        ok( true, "getData6 has generated an integer: " + data );
        start();
    } );
...
asyncTest( "getSum", 1, function () {
    ...
    dataPromise.done( function ( data ) {
        ok( true, "getSum has returned the sum of 2 integers: " + data );
        start();
    } );
